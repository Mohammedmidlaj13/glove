import 'package:mevoicingglove/screens/predefinedoutputscreen.dart';
import 'package:mevoicingglove/screens/usermanual.dart';
...
import 'screens/usermanual.dart';
import 'screens/usermanual2.dart';
//Code
      ...
      child: MaterialApp(
        routes: {
          '/main':(context)=>MainScreen(),
           ...
           '/outputscreen':(context)=>Predefined_OutputScreen(),
          '/customisationpage':(context)=>CustomisationPage(),
          '/usermanual1':(context)=>UserManual(),
